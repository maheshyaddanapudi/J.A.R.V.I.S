...
| R-CAP-02 | MCP primary protocol + adapter families (CLI/HTTP/OpenAPI/GraphQL/WS/DB/FS/HA/MQTT/Matter/…/ROS 2) | 5.2 | G6, E1 | 3/5 | AT3.*, AT5.* | SPEC | D-0011 |
...
| R-MEM-03 | Provenance, confidence, dates, expiration, retention, sensitivity; encryption at rest + field-level | 7.2 | H1 | 1–2 | schema review; invariant #3 | SPEC | D-0013 |
